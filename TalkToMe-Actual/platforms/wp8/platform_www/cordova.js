    ...
    try {
        if(window.external) {
			try{
				...
				alert("window external notify command "+command);
				// alert(eval(window.external.Notify(command));
			}catch(e){
				alert("Exception calling window external notify :: " + command + " :: exception=" + e);
			}
        }
        else {
			alert("window.external not available :: command=" + command);
            console.log("window.external not available :: command=" + command);
        }
    }
    catch(e) {
		alert("Exception calling native with command :: " + command + " :: exception=" + e);
